...
RSpec.describe ShortUrlsController, type: :controller do
  ...
  let(:public_attributes) do
    {
      ...
      'shorted_code' => short_url.shorted_code,
  ...
  describe 'create' do
    ...
    it 'creates a short_url' do
      post :create, params: { short_url: { full_url: 'https://www.test.rspec' } }, format: :json
      expect(parsed_response['url']['shorted_code']).to be_a(String)
    end

    it 'does not create a short_url' do
      post :create, params: { short_url: { full_url: 'nope!' } }, format: :json
  ...
  describe 'show' do
    ...
    it 'redirects to the full_url' do
      ...
      get :show, params: { id: short_url.shorted_code }, format: :json
    ...
    it 'increments the click_count for the url' do
      short_url.short_code
      expect { get :show, params: { id: short_url.shorted_code }, format: :json }.to change {
        ShortUrl.find(short_url.id).click_count
      }.by(1)
    end
